...
def rotate(parms):
    ...
    #checking if the cube is none, contains only characters from [A-Z][a-z][0-9], contains exactly 54 characters
    #and has six unique center faces
    if (
       (encodedCube == None) or (encodedCube.isalnum() == False) or 
